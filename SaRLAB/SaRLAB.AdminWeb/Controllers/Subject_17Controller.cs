...
namespace SaRLAB.AdminWeb.Controllers
{
    public class Subject_17 : Controller
    {
        ...
        public Subject_17(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor)
        {
            _env = env;
        ...
        public IActionResult Configuration_Title()
        {
            ...
            ViewBag.ActiveSubMenuLv2 = "titlesubject3";
