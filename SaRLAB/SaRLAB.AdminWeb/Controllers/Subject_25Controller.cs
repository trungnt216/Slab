...
{
    public class Subject_25 : Controller
    {
        ...
        public Subject_25(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public IActionResult Configuration_Subject()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "configurationsubject25";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject25";
            return View(subject);
        }
        ...
        public IActionResult GetAll_Experiment()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "virtuallabsubject25";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject25";
        ...
        public IActionResult GetAll_Conspectus()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "virtuallabsubject25";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Vocabulary()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "tienganhsubject25";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Exam()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "tienganhsubject25";
            ViewBag.ActiveSubMenuLv2 = "examsubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Examenglish()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "tienganhsubject25";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Department_level()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "nghiencuusubject25";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Provincial_level()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "nghiencuusubject25";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_National_level()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "nghiencuusubject25";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Preparation_questions()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "thuchanhsubject25";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Practice_report()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "thuchanhsubject25";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_International_level()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "nghiencuusubject25";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Question()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject25";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject25";
        ...
        public IActionResult GetAll_Theory()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "giaotrinhsubject25";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Practice()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "giaotrinhsubject25";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_ViTheory()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "virtuallabsubject25";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject25";
            return View(documents);
        }
        ...
        public IActionResult GetAll_ViPractice()
        {
            ...
            ViewBag.ActiveMenu = "subject25";
            ViewBag.ActiveSubMenu = "virtuallabsubject25";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject25";
            return View(documents);
        }
