...
{
    public class Subject_13 : Controller
    {
        ...
        public Subject_13(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "configurationsubject13";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject13";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "virtuallabsubject13";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject13";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "virtuallabsubject13";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "tienganhsubject13";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "tienganhsubject13";
            ViewBag.ActiveSubMenuLv2 = "examsubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "tienganhsubject13";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "nghiencuusubject13";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "nghiencuusubject13";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "nghiencuusubject13";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "thuchanhsubject13";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "thuchanhsubject13";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "nghiencuusubject13";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject13";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject13";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "giaotrinhsubject13";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "giaotrinhsubject13";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "virtuallabsubject13";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject13";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject13";
            ViewBag.ActiveSubMenu = "virtuallabsubject13";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject13";
            return View(documents);
        }
