...
namespace SaRLAB.AdminWeb.Controllers
{
    public class Subject_21 : Controller
    {
        ...
        public Subject_21(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor)
        {
            _env = env;
        ...
        public ActionResult Details_RuleClassroom()
        {
            ...
            ViewBag.ActiveMenu = "subject1";
            ViewBag.ActiveSubMenu = "configurationsubject1";
            ViewBag.ActiveSubMenuLv2 = "ruleClassroomSubject1";
            return View(subject);
        }
