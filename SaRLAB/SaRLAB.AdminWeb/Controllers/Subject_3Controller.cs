...
{
    public class Subject_3 : Controller
    {
        ...
        public Subject_3(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public IActionResult Configuration_Subject()
        {
            ...
            HttpResponseMessage response_sub1 = _httpClient.GetAsync(_httpClient.BaseAddress + "Subject/GetByID/8").Result;
            if (response_sub1.IsSuccessStatusCode)
            {
                string data = response_sub1.Content.ReadAsStringAsync().Result;
            ...
            ViewBag.ActiveSubMenuLv2 = "configurationsubject3";
            return View(subject);
        }
        ...
        public IActionResult GetAll_Experiment()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "virtuallabsubject3";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject3";
        ...
        public IActionResult GetAll_Conspectus()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "virtuallabsubject3";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Vocabulary()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "tienganhsubject3";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Exam()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "tienganhsubject3";
            ViewBag.ActiveSubMenuLv2 = "examsubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Examenglish()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "tienganhsubject3";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Department_level()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "nghiencuusubject3";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Provincial_level()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "nghiencuusubject3";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_National_level()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "nghiencuusubject3";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Preparation_questions()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "thuchanhsubject3";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Practice_report()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "thuchanhsubject3";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_International_level()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "nghiencuusubject3";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Question()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject3";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject3";
        ...
        public IActionResult GetAll_Theory()
        {
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "giaotrinhsubject3";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Practice()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "giaotrinhsubject3";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_ViTheory()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "virtuallabsubject3";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject3";
            return View(documents);
        }
        ...
        public IActionResult GetAll_ViPractice()
        {
            ...
            ViewBag.ActiveMenu = "subject3";
            ViewBag.ActiveSubMenu = "virtuallabsubject3";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject3";
            return View(documents);
        }
