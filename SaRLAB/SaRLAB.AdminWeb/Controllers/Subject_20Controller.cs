...
{
    public class Subject_20 : Controller
    {
        ...
        public Subject_20(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "configurationsubject20";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject20";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "virtuallabsubject20";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject20";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "virtuallabsubject20";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "tienganhsubject20";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "tienganhsubject20";
            ViewBag.ActiveSubMenuLv2 = "examsubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "tienganhsubject20";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "nghiencuusubject20";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "nghiencuusubject20";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "nghiencuusubject20";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "thuchanhsubject20";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "thuchanhsubject20";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "nghiencuusubject20";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject20";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject20";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "giaotrinhsubject20";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "giaotrinhsubject20";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "virtuallabsubject20";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject20";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject20";
            ViewBag.ActiveSubMenu = "virtuallabsubject20";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject20";
            return View(documents);
        }
