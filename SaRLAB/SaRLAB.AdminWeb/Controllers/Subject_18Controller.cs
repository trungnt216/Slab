...
{
    public class Subject_18 : Controller
    {
        ...
        public Subject_18(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "configurationsubject18";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject18";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "virtuallabsubject18";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject18";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "virtuallabsubject18";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "tienganhsubject18";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "tienganhsubject18";
            ViewBag.ActiveSubMenuLv2 = "examsubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "tienganhsubject18";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "nghiencuusubject18";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "nghiencuusubject18";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "nghiencuusubject18";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "thuchanhsubject18";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "thuchanhsubject18";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "nghiencuusubject18";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject18";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject18";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "giaotrinhsubject18";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "giaotrinhsubject18";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "virtuallabsubject18";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject18";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject18";
            ViewBag.ActiveSubMenu = "virtuallabsubject18";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject18";
            return View(documents);
        }
