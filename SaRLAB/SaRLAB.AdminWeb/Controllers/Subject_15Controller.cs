...
{
    public class Subject_15 : Controller
    {
        ...
        public Subject_15(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "configurationsubject15";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject15";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "virtuallabsubject15";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject15";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "virtuallabsubject15";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "tienganhsubject15";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "tienganhsubject15";
            ViewBag.ActiveSubMenuLv2 = "examsubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "tienganhsubject15";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "nghiencuusubject15";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "nghiencuusubject15";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "nghiencuusubject15";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "thuchanhsubject15";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "thuchanhsubject15";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "nghiencuusubject15";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject15";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject15";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "giaotrinhsubject15";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "giaotrinhsubject15";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "virtuallabsubject15";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject15";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject15";
            ViewBag.ActiveSubMenu = "virtuallabsubject15";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject15";
            return View(documents);
        }
