...
{
    public class Subject_10 : Controller
    {
        ...
        public Subject_10(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "configurationsubject10";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject10";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "virtuallabsubject10";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject10";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "virtuallabsubject10";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "tienganhsubject10";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "tienganhsubject10";
            ViewBag.ActiveSubMenuLv2 = "examsubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "tienganhsubject10";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "nghiencuusubject10";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "nghiencuusubject10";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "nghiencuusubject10";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "thuchanhsubject10";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "thuchanhsubject10";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "nghiencuusubject10";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject10";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject10";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "giaotrinhsubject10";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "giaotrinhsubject10";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "virtuallabsubject10";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject10";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject10";
            ViewBag.ActiveSubMenu = "virtuallabsubject10";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject10";
            return View(documents);
        }
