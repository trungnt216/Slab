...
{
    public class Subject_24 : Controller
    {
        ...
        public Subject_24(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "configurationsubject24";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject24";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "virtuallabsubject24";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject24";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "virtuallabsubject24";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "tienganhsubject24";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "tienganhsubject24";
            ViewBag.ActiveSubMenuLv2 = "examsubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "tienganhsubject24";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "nghiencuusubject24";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "nghiencuusubject24";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "nghiencuusubject24";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "thuchanhsubject24";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "thuchanhsubject24";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "nghiencuusubject24";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject24";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject24";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "giaotrinhsubject24";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "giaotrinhsubject24";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "virtuallabsubject24";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject24";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject24";
            ViewBag.ActiveSubMenu = "virtuallabsubject24";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject24";
            return View(documents);
        }
