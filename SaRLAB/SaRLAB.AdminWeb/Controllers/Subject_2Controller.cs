...
{
    public class Subject_2 : Controller
    {
        ...
        public Subject_2(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            HttpResponseMessage response_sub1 = _httpClient.GetAsync(_httpClient.BaseAddress + "Subject/GetByID/7").Result;
            if (response_sub1.IsSuccessStatusCode)
            {
                string data = response_sub1.Content.ReadAsStringAsync().Result;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveSubMenuLv2 = "experimentsubject2";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "virtuallabsubject2";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "tienganhsubject2";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "tienganhsubject2";
            ViewBag.ActiveSubMenuLv2 = "examsubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "tienganhsubject2";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "nghiencuusubject2";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "nghiencuusubject2";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "nghiencuusubject2";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "thuchanhsubject2";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "thuchanhsubject2";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "nghiencuusubject2";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "giaotrinhsubject2";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "giaotrinhsubject2";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "virtuallabsubject2";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject2";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject2";
            ViewBag.ActiveSubMenu = "virtuallabsubject2";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject2";
            return View(documents);
        }
