...
{
    public class Subject_14 : Controller
    {
        ...
        public Subject_14(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "configurationsubject14";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject14";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "virtuallabsubject14";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject14";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "virtuallabsubject14";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "tienganhsubject14";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "tienganhsubject14";
            ViewBag.ActiveSubMenuLv2 = "examsubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "tienganhsubject14";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "nghiencuusubject14";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "nghiencuusubject14";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "nghiencuusubject14";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "thuchanhsubject14";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "thuchanhsubject14";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "nghiencuusubject14";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject14";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject14";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "giaotrinhsubject14";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "giaotrinhsubject14";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "virtuallabsubject14";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject14";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject14";
            ViewBag.ActiveSubMenu = "virtuallabsubject14";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject14";
            return View(documents);
        }
