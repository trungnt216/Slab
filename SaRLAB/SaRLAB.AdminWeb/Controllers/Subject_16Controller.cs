...
{
    public class Subject_16 : Controller
    {
        ...
        public Subject_16(ILogger<HomeController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "configurationsubject16";
            ViewBag.ActiveSubMenuLv2 = "configurationsubject16";
            return View(subject);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "virtuallabsubject16";
            ViewBag.ActiveSubMenuLv2 = "experimentsubject16";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "virtuallabsubject16";
            ViewBag.ActiveSubMenuLv2 = "conspectussubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "tienganhsubject16";
            ViewBag.ActiveSubMenuLv2 = "vocabularysubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "tienganhsubject16";
            ViewBag.ActiveSubMenuLv2 = "examsubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "tienganhsubject16";
            ViewBag.ActiveSubMenuLv2 = "examenglishsubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "nghiencuusubject16";
            ViewBag.ActiveSubMenuLv2 = "departmentLevelsubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "nghiencuusubject16";
            ViewBag.ActiveSubMenuLv2 = "provincialLevelsubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "nghiencuusubject16";
            ViewBag.ActiveSubMenuLv2 = "nationalLevelsubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "thuchanhsubject16";
            ViewBag.ActiveSubMenuLv2 = "preparationQuestionssubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "thuchanhsubject16";
            ViewBag.ActiveSubMenuLv2 = "practiceReportsubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "nghiencuusubject16";
            ViewBag.ActiveSubMenuLv2 = "internationalLevelsubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "cauhoiantoansubject16";
            ViewBag.ActiveSubMenuLv2 = "cauhoisubject16";
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenuMain = "subject";
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "giaotrinhsubject16";
            ViewBag.ActiveSubMenuLv2 = "gttheorysubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "giaotrinhsubject16";
            ViewBag.ActiveSubMenuLv2 = "gtpracticesubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "virtuallabsubject16";
            ViewBag.ActiveSubMenuLv2 = "vitheorysubject16";
            return View(documents);
        }
...
TempData["noticeCount"] = notice.Count;
            ...
            ViewBag.ActiveMenu = "subject16";
            ViewBag.ActiveSubMenu = "virtuallabsubject16";
            ViewBag.ActiveSubMenuLv2 = "vipracticesubject16";
            return View(documents);
        }
