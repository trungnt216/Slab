...
{
    public class Subject_3Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 3;

        string Subject_name = "~/Views/Subject_3/_Layout.cshtml";
        ...
        public Subject_3Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject3";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject3MarkFlag = true;
