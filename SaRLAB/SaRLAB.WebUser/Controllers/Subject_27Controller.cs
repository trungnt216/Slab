...
{
    public class Subject_27Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 27;

        string Subject_name = "~/Views/Subject_27/_Layout.cshtml";
        ...
        public Subject_27Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject27MarkFlag = true;
