...
{
    public class Subject_19Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 19;

        string Subject_name = "~/Views/Subject_19/_Layout.cshtml";
        ...
        public Subject_19Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject19";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject19MarkFlag = true;
