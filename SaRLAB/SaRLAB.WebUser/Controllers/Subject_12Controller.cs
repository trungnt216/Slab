...
{
    public class Subject_12Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 12;

        string Subject_name = "~/Views/Subject_12/_Layout.cshtml";
        ...
        public Subject_12Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject12";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject12MarkFlag = true;
