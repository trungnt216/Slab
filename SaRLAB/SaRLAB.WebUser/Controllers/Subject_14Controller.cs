...
{
    public class Subject_14Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 14;

        string Subject_name = "~/Views/Subject_14/_Layout.cshtml";
        ...
        public Subject_14Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject14";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject14MarkFlag = true;
