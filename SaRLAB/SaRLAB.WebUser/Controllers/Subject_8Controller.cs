...
{
    public class Subject_8Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 8;

        string Subject_name = "~/Views/Subject_8/_Layout.cshtml";
        ...
        public Subject_8Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject8";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject8MarkFlag = true;
