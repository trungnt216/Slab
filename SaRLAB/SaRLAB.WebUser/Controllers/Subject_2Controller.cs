...
{
    public class Subject_2Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 2;

        string Subject_name = "~/Views/Subject_2/_Layout.cshtml";
        ...
        public Subject_2Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject2";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject2MarkFlag = true;
