...
{
    public class Subject_9Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 9;

        string Subject_name = "~/Views/Subject_9/_Layout.cshtml";
        ...
        public Subject_9Controller(ILogger<HomePageController> logger, IConfiguration configuration, IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject9";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject9MarkFlag = true;
