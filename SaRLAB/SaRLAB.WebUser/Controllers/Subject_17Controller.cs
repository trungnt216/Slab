...
{
    public class Subject_17Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 17;

        string Subject_name = "~/Views/Subject_17/_Layout.cshtml";
        ...
        public Subject_17Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject17";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject17MarkFlag = true;
