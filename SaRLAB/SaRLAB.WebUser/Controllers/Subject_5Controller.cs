...
{
    public class Subject_5Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 5;

        string Subject_name = "~/Views/Subject_5/_Layout.cshtml";
        ...
        public Subject_5Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject5";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject5MarkFlag = true;
