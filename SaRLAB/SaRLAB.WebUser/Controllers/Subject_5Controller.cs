...
namespace SaRLAB.UserWeb.Controllers
{
    public class Subject_5Controller : Controller
    {
        ...
        public Subject_5Controller(ILogger<HomePageController> logger, IConfiguration configuration, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public IActionResult GetAll_Theory()
        {
            ...
            ViewBag.ActiveSubMenuLv2 = "theory";
            return View(documents);
        }
        ...
        public IActionResult GetAll_Practice()
        {
            ...
            ViewBag.ActiveMenu = "subject5";
            ViewBag.ActiveSubMenu = "giaotrinh";
            ViewBag.ActiveSubMenuLv2 = "practice";
            return View(documents);
        }
        ...
        public IActionResult GetAll_ViTheory()
        {
            ...
            ViewBag.ActiveMenu = "subject5";
            ViewBag.ActiveSubMenu = "virtualLab";
            ViewBag.ActiveSubMenuLv2 = "vitheory";
            return View(documents);
        }
