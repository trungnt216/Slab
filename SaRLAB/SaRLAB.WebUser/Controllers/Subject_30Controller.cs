...
namespace SaRLAB.UserWeb.Controllers
{
    public class Subject_30Controller : Controller
    {
        ...
        public Subject_30Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject30MarkFlag = true;
