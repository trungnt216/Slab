...
{
    public class Subject_16Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 16;

        string Subject_name = "~/Views/Subject_16/_Layout.cshtml";
        ...
        public Subject_16Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject16";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject16MarkFlag = true;
