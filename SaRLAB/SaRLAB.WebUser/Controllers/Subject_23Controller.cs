...
{
    public class Subject_23Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 23;

        string Subject_name = "~/Views/Subject_23/_Layout.cshtml";
        ...
        public Subject_23Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject23";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject23MarkFlag = true;
