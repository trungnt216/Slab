...
{
    public class Subject_20Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 20;

        string Subject_name = "~/Views/Subject_20/_Layout.cshtml";
        ...
        public Subject_20Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject20";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject20MarkFlag = true;
