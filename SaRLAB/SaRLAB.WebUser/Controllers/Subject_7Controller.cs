...
{
    public class Subject_7Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 7;

        string Subject_name = "~/Views/Subject_7/_Layout.cshtml";
        ...
        public Subject_7Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject7";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject7MarkFlag = true;
