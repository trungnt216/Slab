...
{
    public class Subject_26Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 26;

        string Subject_name = "~/Views/Subject_26/_Layout.cshtml";
        ...
        public Subject_26Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject26";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject26MarkFlag = true;
