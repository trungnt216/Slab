...
{
    public class Subject_10Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 10;

        string Subject_name = "~/Views/Subject_10/_Layout.cshtml";
        ...
        public Subject_10Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject10";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject10MarkFlag = true;
