...
{
    public class Subject_28Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 28;

        string Subject_name = "~/Views/Subject_28/_Layout.cshtml";
        ...
        public Subject_28Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject28";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject28MarkFlag = true;
