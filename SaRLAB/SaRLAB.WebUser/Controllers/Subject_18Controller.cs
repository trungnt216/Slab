...
{
    public class Subject_18Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 18;

        string Subject_name = "~/Views/Subject_18/_Layout.cshtml";
        ...
        public Subject_18Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject18";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject18MarkFlag = true;
