...
{
    public class Subject_15Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 15;

        string Subject_name = "~/Views/Subject_15/_Layout.cshtml";
        ...
        public Subject_15Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject15";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject15MarkFlag = true;
