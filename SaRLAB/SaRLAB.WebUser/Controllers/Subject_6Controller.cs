...
{
    public class Subject_6Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 6;

        string Subject_name = "~/Views/Subject_6/_Layout.cshtml";
        ...
        public Subject_6Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject6";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject6MarkFlag = true;
