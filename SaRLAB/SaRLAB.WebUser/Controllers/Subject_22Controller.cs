...
{
    public class Subject_22Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 22;

        string Subject_name = "~/Views/Subject_22/_Layout.cshtml";
        ...
        public Subject_22Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject22";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject22MarkFlag = true;
