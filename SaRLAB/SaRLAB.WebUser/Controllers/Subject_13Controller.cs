...
{
    public class Subject_13Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 13;

        string Subject_name = "~/Views/Subject_13/_Layout.cshtml";
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject13";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject13MarkFlag = true;
