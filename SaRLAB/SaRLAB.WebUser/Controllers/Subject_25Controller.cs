...
{
    public class Subject_25Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 25;

        string Subject_name = "~/Views/Subject_25/_Layout.cshtml";
        ...
        public Subject_25Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject25";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject25MarkFlag = true;
