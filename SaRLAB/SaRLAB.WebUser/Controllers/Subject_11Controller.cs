...
{
    public class Subject_11Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 11;

        string Subject_name = "~/Views/Subject_11/_Layout.cshtml";
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject11";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject11MarkFlag = true;
