...
{
    public class Subject_21Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 21;

        string Subject_name = "~/Views/Subject_21/_Layout.cshtml";
        ...
        public Subject_21Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject21";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject21MarkFlag = true;
