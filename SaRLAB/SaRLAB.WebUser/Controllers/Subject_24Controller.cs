...
{
    public class Subject_24Controller : Controller
    {
        string pathFolderSave = null;

        int Subject_id = 24;

        string Subject_name = "~/Views/Subject_24/_Layout.cshtml";
        ...
        public Subject_24Controller(ILogger<HomePageController> logger, IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment env)
        {
            _env = env;
        ...
        public ActionResult Home()
        {
            ...
            TempData["action"] = "GetAllQuestion_Subject24";
        ...
        public ActionResult Index()
        {
            ...
            subjectFlag.BackupSubject24MarkFlag = true;
